...
lang="de"	# language of text, en, de, fr etc ...
...
def getf(i):
        os.system("curl -A 'Mozilla' 'http://translate.google.com/translate_tts?tl="+lang+"&q="+i+"' > out.mp3")

		#gets spoken text and append to outputfile
def get(i):
	os.system("curl -A 'Mozilla' 'http://translate.google.com/translate_tts?tl="+lang+"&q="+i+"' > tmp.mp3")
